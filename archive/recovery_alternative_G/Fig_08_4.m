function [] = Fig_08_4
% FIG_08_4 - Assisted differential MBLL analysis using G(d) = OD(mu_a = 0,d).
%
...
%                       G(d) = OD(mu_a = 0,d).
%
% Differential optical density is formed relative to the zero-absorption
% reference condition. This is the assisted inversion: the DPF associated
% with the true mu_a is supplied directly for each simulated condition,
% allowing the intrinsic performance of each DPF model to be evaluated
% independently of the DPF-selection problem.
%
