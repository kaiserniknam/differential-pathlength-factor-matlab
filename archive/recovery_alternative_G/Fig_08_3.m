function [] = Fig_08_3
% FIG_08_3 - Assisted absolute MBLL analysis using G(d) = OD(mu_a = 0,d).
%
...
% The geometry/scattering contribution is defined from the zero-absorption
% simulation as
%
%                       G(d) = OD(mu_a = 0,d).
%
% This is the assisted inversion: for each simulated absorption condition,
% the DPF corresponding to the true mu_a is supplied directly to the MBLL
% equation. The resulting recovery therefore represents the performance
% of each DPF model when its correct mu_a-dependent value is known.
%
% The script compares constant, semi-infinite, mean-pathlength,
% slope-based, true, inverse-distance, and empirical DPF models and
% evaluates absorption recovery versus source-detector distance.
