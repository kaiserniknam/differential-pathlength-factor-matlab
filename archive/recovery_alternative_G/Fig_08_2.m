function [] = Fig_08_2
% FIG_08_2 - Absolute MBLL analysis using G(d) = OD(mu_a = 0,d).
%
...
% Unlike Fig_07_2, the geometry/scattering contribution is defined from
% the zero-absorption simulation as
%
%                       G(d) = OD(mu_a = 0,d),
%
% so a distance-dependent baseline is removed from the measured OD before
% solving the MBLL equation.
%
...
% without supplying the DPF corresponding to the true mu_a.
%
